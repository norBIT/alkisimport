...
osgeo4w:
	...
	cp alkis-import.sh re refilter.py alkis-ableitungsregeln.sql alkis-compat.sql alkis-functions.sql alkis-nutzung-und-klassifizierung.sql alkis-schema.sql alkis-signaturen.sql alkis-wertearten.sql alkis-update.sql alkisImport.py alkisImportDlg.ui about.ui cleanGeometry.sql custom logo.ico logo.svg osgeo4w/apps/alkis-import
