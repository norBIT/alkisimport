...
WHERE (abmarkung_marke<>9500 OR (abmarkung_marke = 9500 AND (p.gml_id LIKE 'DENW%' OR  p.gml_id LIKE 'DESH%'))) AND p.endet IS NULL AND greatest(p.beginnt, itv.beginnt, o.beginnt)>lastrun;
