...
(OGR2OGR|Warning 1): Skipping field '(LI_Source|datumDerLetztenUeberpruefung|CI_RoleCode|AX_LI_ProcessStep_Punktort_Description|AX_Datenerhebung_Punktort|CI_RoleCode|AX_LI_ProcessStep_OhneDatenerhebung_Description|AX_LI_ProcessStep_MitDatenerhebung_Description|AX_Datenerhebung)' not found in destination layer 'ax_.*'\.
